...
MQTT_BROKER = "18.208.160.16"  # Substitua pelo endereço do seu broker
MQTT_TOPIC = "/TEF/device001/attrs/p"  # Substitua pelo seu tópico
...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        ultimo_valor = payload  # Supondo que o payload seja um objeto JSON
        socketio.emit('novo_dado', {'valor': ultimo_valor})  # Emite dados para o cliente
        print(f"Mensagem recebida: {ultimo_valor}")  # Saída de depuração
...
def index():
    return render_template_string('''
        ...
        <body>
            <div class="container">
                <h1 class="mt-5">Potenciômetro</h1>
            ...
            <script>
                ...
                $(document).ready(function() {
                    ...
                    socket.on('novo_dado', function(data) {
                        $('#valor-potenciometro').text('Medição: ' + data.valor);
